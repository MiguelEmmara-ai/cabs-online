...
@section('container')
    ...
    <section class="login-clean" style="padding-top: 180px;">
        <form action="login" method="POST">
            ...
            <div class="mb-3">
                <input type="text" name="username" placeholder="Username" class="form-control @php echo !empty($username_err) ? 'is-invalid' : ''; @endphp"
                    value="@php echo $username; @endphp" required="">
                <span class="invalid-feedback">@php echo $username_err; @endphp</span>
            </div>
            <div class="mb-3">
                <input type="password" name="password" placeholder="Password" class="form-control @php echo !empty($password_err) ? 'is-invalid' : ''; @endphp"
                    required="">
